                ...
                <form action="{{ route('reserve.update') }}" method="post">
                    ...
                    <table class="reserves_card_tb">
                        ...
                        <tr>
                            <th>Date</th>
                            <td>
                                <input type="date" name="started_at" class="update_input_date"
                        ...
                        <tr>
                            ...
                            <td>
                                <select name="time" class="update_time_select" id="time_select">
                                    <option
                                        value="{{ old('started_at',\Carbon\Carbon::parse($reservation->started_at)->format('H:i')) }}">
                                        {{ \Carbon\Carbon::parse($reservation->started_at)->format('H:i') }}</option>
                                </select>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <select name="num_of_users" class="update_num_select" id="num_select">
                                    <option
                                        value="{{ old('started_at',\Carbon\Carbon::parse($reservation->started_at)->format('H:i')) }}">
                                        {{ $reservation->num_of_users }}人</option>
                                </select>
                            </td>
                        </tr>
                        <tr>
