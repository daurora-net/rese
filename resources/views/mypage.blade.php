            ...
            <tr>
              ...
              <td>
                <select name="time" class="update_time_select" id="time_select">
                  ...
                  <option value="{{ old('started_at',\Carbon\Carbon::parse($reservation->started_at)->format('H:i')) }}">{{ old('started_at',\Carbon\Carbon::parse($reservation->started_at)->format('H:i')) }}
                  </option>
                </select>
              </td>
            </tr>
